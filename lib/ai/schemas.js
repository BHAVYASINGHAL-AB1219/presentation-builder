    ...
    slides: {
      ...
      items: {
        ...
        properties: {
          ...
          section: {
            type: "string",
            description: "Section name for grouping slides",
          },
          title: {
            type: "string",
          ...
          talking_points: {
            type: "array",
            items: { type: "string" },
            description: "Key ideas this slide should cover",
          },
          suggested_layout: {
            type: "string",
            description:
              "One of the available layout types. Choose whichever fits the slide content best.",
          },
        },
        required: [
          "slide_number",
      ...
      items: {
        ...
        properties: {
          ...
          layout_type: {
            type: "string",
            description:
              "The layout type for this slide. Choose whichever fits the content best.",
          },
          ...
          stat_number: {
            type: "string",
            description: "A large statistic if applicable",
          },
          stat_label: {
            type: "string",
